...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    role: 'client',
    demoStep: 2,
    tooltipTitle: 'Questionnaire climat',
    tooltipText: "Le client remplit 4 blocs : cartographie des dispositifs, auto-évaluation, enjeux sectoriels, et perception RSE. Environ 30 minutes.",
  },
  {
    route: '/client/sondage',
    role: 'client',
    demoStep: 3,
    tooltipTitle: 'Sondage anonyme',
    tooltipText: "Les collaborateurs répondent à 10 questions via un lien anonyme. L'analyste suit les réponses en temps réel.",
  },
  {
    route: '/client/documents',
    role: 'client',
    demoStep: 3,
    tooltipTitle: 'Corpus documentaire',
    tooltipText: "Le client partage ses documents (Bilan Carbone, rapport RSE, organigramme). L'analyste valide le corpus.",
  },
  {
    ...
    tooltipText: "L'analyste Celsius travaille sur le diagnostic. Le client voit une page d'attente avec l'avancement.",
  },
  {
  ...
  {
    route: '/admin/diagnostic/diag-001',
    role: 'admin',
    demoStep: 6,
    tooltipTitle: 'Espace de travail analyste',
