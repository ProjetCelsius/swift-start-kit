// NAF codes niveau 2 (sections + divisions)
export interface NafCode {
  code: string
  label: string
}

export const NAF_CODES_LEVEL2: NafCode[] = [
  { code: '01', label: 'Culture et production animale, chasse' },
  ...
  { code: '16', label: 'Travail du bois (sauf fabrication de meubles)' },
  ...
  { code: '59', label: 'Production de films, vidéo et programmes de télévision ; enregistrement sonore et édition musicale' },
